...
export const initialMountains = [
  ...
  // ================= 四大佛教名山 =================
  {
    ...
    label: '文殊菩萨道场', province: '山西', elevation: 3058, climbingGain: 1500, icon: '📿', status: 'none', visible: false,
    description: '中国佛教四大名山之首。拥有极具规模的寺庙建筑群，不仅是佛教圣地，也拥有壮丽的高山草甸自然风光。'
  },
  {
    id: 'pts', name: '普陀山', category: 'buddhist', value: [122.38, 29.98, 100],
    label: '海天佛国', province: '浙江', elevation: 291, climbingGain: 280, icon: '🪷', status: 'none', visible: false,
    description: '观音菩萨的道场。四面环海，风光旖旎，寺院依山傍水而建。这里有着"南海圣境"的幽静与神圣。'
  },
  {
    id: 'ems', name: '峨眉山', category: 'buddhist', value: [103.3344, 29.5451, 100],
    label: '云海佛光', province: '四川', elevation: 3099, climbingGain: 2600, icon: '/src/assets/mountains/ems.jpg', status: 'wishlist', visible: true,
  ...
  // ================= 自由探索 =================
  {
    ...
    label: '天空之城', province: '贵州', elevation: 2572, climbingGain: 1200, icon: '/src/assets/mountains/fjs.jpg', status: 'wishlist', visible: true,
    description: '武陵山脉的主峰，世界自然遗产。红云金顶拔地而起，蘑菇石傲然挺立。这里是一座拥有古老地质史的孤岛秘境。'
  },
  {
    id: 'wgs', name: '武功山', category: 'others', value: [114.1003, 27.4845, 100],
    label: '云中草原', province: '江西', elevation: 1918, climbingGain: 1400, icon: '/src/assets/mountains/wgs.jpg', status: 'wishlist', visible: true,
  ...
  },
  {
    ...
    label: '关东第一山', province: '吉林', elevation: 2691, climbingGain: 1940, icon: '/src/assets/mountains/cbs.jpg', status: 'visited', visible: true,
  ...
  },
  {
    ...
    label: '天下无双圣境', province: '河南', elevation: 2596, climbingGain: 1600, icon: '/src/assets/mountains/ljs.jpg', status: 'visited', visible: true,
  ...
  },
  {
    ...
    label: '蓝色星球净土', province: '四川', elevation: 5592, climbingGain: 1200, icon: '🏔️', status: 'none', visible: false,
